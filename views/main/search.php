        ...
        while($row = mysqli_fetch_array($usersReturnedQuery)) {
            ...
            echo "<div class='search_result'>
					...
					<div class='result_profile_pic'>
						<a href='../user/profile.php?profile_username=" . $row['username'] ."'><img src='../../". $row['profile_pic'] ."' style='height: 100px; border-radius: 10px;'></a>
					</div>

						<a href='../user/profile.php?profile_username=" . $row['username'] ."'> " . $row['first_name'] . " " . $row['last_name'] . "
