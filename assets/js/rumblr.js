...
function getLiveSearchUsers(value, user) {
  $.post(
    ...
    function (data) {
      ...
      $(".search_results_footer").html(
        "<a href='../main/search.php?q=" + value + "'>See All Results</a>"
      );
...
function getLiveSearchUsers(id, user) {
  $.post(
    "../../includes/handlers/ajax_search.php",
    { query: id, userLoggedIn: user },
    function (data) {
      if ($(".search_results_footer_empty")[0]) {
        $(".search_results_footer_empty").toggleClass("search_results_footer");
        $(".search_results_footer_empty").toggleClass(
      ...
      $(".search_results").html(data);
      $(".search_results_footer").html(
        "<a href='../main/search.php?q=" + id + "'>See All Results</a>"
      );
