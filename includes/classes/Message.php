...
class Message {
	...
	public function getConvosDropdown($data, $limit) {
		...
		foreach($convos as $username) {
			...
			$return_string .= "<a href='../main/messages.php?u=$username' style='font-family: 'HelveticaNeueCyr-Light';'> 
								<div class='user_found_messages' style='" . $style . "'>
								<img src='../../" . $user_found_obj->getProfilePic() . "' style='border-radius: 5px; margin-right: 5px;'>
								" . $user_found_obj->getFirstAndLastName() . "
								<span class='timestamp_smaller' id='grey' style='font-family: 'HelveticaNeueCyr-Light';'> " . $latest_message_details[2] . "</span>
								<p id='grey' style='margin: 0; font-family: 'HelveticaNeueCyr-Light';'>" . $latest_message_details[0] . $split . " </p>
								</div>
								</a>";
		}
